export const songs = [
  {
    ...
    performers: [
      ...
      { role: 'Guitar', names: ['백용우 & 안대경'] },
      { role: 'Piano', names: ['김예준'] },
      { role: 'Bass', names: ['김윤호'] },
      { role: 'Drum', names: ['이은율'] },
    ],
    lyrics: `용기 내어보려 노력했는데 
왜 네 앞에서는 다 어색해지고
꽤 자연스럽던 내 인사마저도
마음대로 되지가 않아
...
뒤돌아보면 언제나 그랬듯 서있을 거야`,
  },
  {
    ...
    originalArtist: '유재하',
    performers: [
      { role: 'Vocal', names: ['박민주 & 김시우'] },
      { role: 'Guitar', names: ['박시우'] },
      { role: 'Piano', names: ['박찬'] },
    ],
    lyrics: `처음 느낀 그대 눈빛은
혼자만의 오해였던가요
...
사랑하기 때문에`,
  },
  {
    ...
    originalArtist: '로이킴',
    performers: [
      { role: 'Vocal', names: ['김상우'] },
      { role: 'Guitar', names: ['김상우'] },
      { role: 'Piano', names: ['이승환'] },
      { role: 'Bass', names: ['민홍조'] },
      { role: 'Drum', names: ['임건형'] },
    ],
    lyrics: `오늘도 그대는 웃네요
...
그대만을 I Love You`,
  },
  {
    ...
    part: 1,
    number: '04',
    title: '사랑아 너는 나를 위해 울어줄 수 있니',
    originalArtist: '이재경',
    performers: [
      { role: 'Vocal', names: ['심현솔'] },
      { role: 'Guitar', names: ['백용우'] },
      { role: 'Piano', names: ['이승환'] },
      { role: 'Bass', names: ['심송현'] },
      { role: 'Drum', names: ['박성재'] },
    ],
    lyrics: `쉽게 물들어 버리는 마음을 봐요
금방 떠나가 버리는 그 마음을
지쳐 달아난 시간을 그리워해요
나는 내일을 살고 싶은데

사랑아 너는 나를 위해 울어줄 수 있니?
외로운 바다 안고 살아가는 중이라서
이런 내 마음을 눈물로 가득히 채워 주겠니
사랑을 하자 밀려오는 저 파도 너머에
아아 –
...
외로운 바다 안고 살아가는 중이라서
이런 내 마음을 눈물로 가득히 채워 주겠니
시린 밤도 마주하게 하는 무거운 눈물로 아아 –
너의 사랑은 나를 살게 하고

사랑아 너는 나를 위해 울어줄 수 있니?
외로운 바다 안고 살아가는 내게
사랑아 나를 영원토록 품어줄 수 있니?
이 마음 안에 밝은 빛이 가득하도록
저 파도 너머 사랑을 하자`,
  },
  {
    ...
    originalArtist: '조이',
    performers: [
      { role: 'Vocal', names: ['박민주'] },
      { role: 'Guitar', names: ['김우준'] },
      { role: 'Piano', names: ['김한율'] },
      { role: 'Bass', names: ['민홍조'] },
      { role: 'Drum', names: ['박성재'] },
    ],
    lyrics: `창 밖엔 서글픈 비만 내려오네
내 마음 너무 안타까워
이젠 다시 볼 수가 없기에
...
Love Love Love`,
  },
  {
    ...
    originalArtist: 'LUCY',
    performers: [
      { role: 'Vocal', names: ['노은성'] },
      { role: 'Guitar', names: ['김우준'] },
      { role: 'Piano', names: ['정윤섭'] },
      { role: 'Bass', names: ['권혜승'] },
      { role: 'Drum', names: ['홍준서'] },
    ],
    lyrics: `멀어져 가는 꿈의 잔상처럼
...
넌 웃어줘 함께 놀던 그날처럼`,
  },
  {
    ...
    originalArtist: '10CM',
    performers: [
      { role: 'Vocal', names: ['신아민'] },
      { role: 'Guitar', names: ['백용우'] },
      { role: 'Piano', names: ['김률아'] },
      { role: 'Bass', names: ['구도윤'] },
      { role: 'Drum', names: ['최민우'] },
    ],
    lyrics: `따사로운 햇살 속에서
...
이어져 가서는 닿기를`,
  },
  {
    ...
    originalArtist: '이광조',
    performers: [
      { role: 'Vocal', names: ['이강민'] },
      { role: 'Guitar', names: ['서동민'] },
      { role: 'Piano', names: ['정윤섭 & 심송현'] },
      { role: 'Bass', names: ['민홍조'] },
      { role: 'Drum', names: ['박성재'] },
    ],
    lyrics: `눈부신 태양 아래로 사랑이 익어가는 거리
...
근심 걱정 하늘로 날리는 우리는 행복한 연인`,
  },
  {
    ...
    lyrics: `이 밤 시간이 멈춰진듯해
모두 얼굴에 피칠을 하고
겁을 내기는커녕
즐거워하는 유령의 밤
나는 일 년 만에 외출을 했어
오늘 이 밤은 나를 위한 파티
사람들은 내가 분장을 한 줄로 알겠지

It seemed forever stopped today
I'm gentle monster
누구 한 명쯤 사라져도 몰라
그대 하얀 목덜미에 이빨을 넣어도 될까요
아마 황홀할 거예요
It seemed forever stopped today
I'm gentle monster
내 번호를 따도 난 전화가 없죠
그대 향긋한 피 냄새에 나 취할 것 같아요
오늘 함께 있어요

모두 모여서 춤을 춥시다
괴물과 인간이 어울리는 파티
사실 이 중에 진짜 인간이라면 너 혼자야
한 발짝 한 발짝 내게 들어와
헤어 날 수 없는 칠흑 같은 망토
그대 눈빛이 빛나잖아
마치 깨진 샹들리에
...
내가 영원을 줄게요`,
  },
  {
    ...
    part: 1,
    number: '11',
    title: "Orange You're Not a Joke to Me!",
    originalArtist: '스텔라장',
    performers: [
      { role: 'Vocal', names: ['심현솔'] },
      { role: 'Guitar', names: ['백용우 & 최이흠'] },
      { role: 'Bass', names: ['박성재'] },
      { role: 'Drum', names: ['박승현'] },
    ],
    lyrics: `I was in my dorm room
나는 기숙사 방에서
...
A whole song just for you
너만을 위한 곡을 말이야
A whole song just for you yeah yeah
너만을 위한 곡을 말이야
Orange I love you so much
오렌지야 난 널 정말 사랑해
You and your family too
너와 너의 가족들까지도`,
...

  {
    ...
    originalArtist: '잔나비',
    performers: [
      { role: 'Vocal', names: ['오서진'] },
      { role: 'Guitar', names: ['구도윤'] },
      { role: 'Piano', names: ['현소희 & 김률아'] },
      { role: 'Bass', names: ['심현솔'] },
      { role: 'Drum', names: ['박승현'] },
    ],
    lyrics: `나는 읽기 쉬운 마음이야
당신도 스윽 훑고 가셔요
달랠 길 없는 외로운 마음 있지
머물다 가셔요 음
내게 긴 여운을 남겨줘요
...
또 이렇게 간다`,
  },
  {
    ...
    originalArtist: '디에이드',
    performers: [
      { role: 'Vocal', names: ['권아영'] },
      { role: 'Guitar', names: ['양지훈'] },
    ],
    lyrics: `니 생각에 꽤 즐겁고
니 생각에 퍽 외로워
이상한 일이야 누굴 좋아한단 건
...
그래서 한번 더 가보고 싶어져 너와`,
  },
  {
    ...
    originalArtist: '장범준',
    performers: [
      { role: 'Vocal', names: ['최이흠'] },
      { role: 'Guitar', names: ['최이흠 & 인병두'] },
    ],
    lyrics: `사랑이란 게 원래
시간이 지날수록
설레임보다는
...
눈물 콱 쏟아져 버리고 말았네`,
  },
  {
    ...
    part: 2,
    number: '17',
    title: "Think About' Chu",
    originalArtist: 'Asoto Union',
    performers: [
      { role: 'Vocal', names: ['임선우'] },
      { role: 'Guitar', names: ['정호성'] },
      { role: 'Piano', names: ['정윤섭'] },
      { role: 'Bass', names: ['인병두'] },
      { role: 'Drum', names: ['박성재'] },
    ],
    lyrics: `언제부턴가 많은 말이 왜
우리에게 필요 없었지
수많은 밤을 함께 보낸
우리들에게 다가오는
아름다운 날들
...
사랑에 빠지겠죠 난`,
  },
  {
    ...
    number: '19',
    title: '범퍼카',
    originalArtist: '데이브레이크',
    performers: [
      { role: 'Vocal', names: ['전재민'] },
      { role: 'Guitar', names: ['백용우'] },
      { role: 'Piano', names: ['정윤섭'] },
      { role: 'Bass', names: ['김미미'] },
      { role: 'Drum', names: ['박성재'] },
    ],
    lyrics: `상처투성이 외롭고 험한 싸움터
홀로 버려진 두려움 앞에서
돌격 앞으로 우물쭈물 하다가는
큰일 납니다 비켜나세요
언젠가는 드넓은 대지에
...
이루어지길`,
  },
  {
    ...
    number: '20',
    title: '항해',
    originalArtist: '유다빈밴드',
    performers: [
      { role: 'Vocal', names: ['김주혜'] },
      { role: 'Guitar', names: ['정호성'] },
      { role: 'Piano', names: ['이승환'] },
      { role: 'Bass', names: ['인병두'] },
      { role: 'Drum', names: ['홍준서'] },
    ],
    lyrics: `수없이 연결된 실 속에서
사랑한 너와 나의 모습은
헝클어진 채로 버려지고 말았지
영원히 남을 매듭과
시간의 흐름을 기억하는 것
...
단 하나의 꿈이야`,
  },
  {
    ...
    performers: [
      { role: 'Vocal', names: ['노은성'] },
      { role: 'Guitar', names: ['백용우'] },
      { role: 'Piano', names: ['정윤섭 & 유승빈'] },
      { role: 'Bass', names: ['인병두'] },
      { role: 'Drum', names: ['박성재'] },
    ],
    lyrics: `Lately I've been
